...
**Current `main` development version:** `3.2.0rc1`
...
Spec Kitty currently ships stable `3.1.x` releases while `main` carries the active `3.2.0rc1` release-candidate line.
...
| **main** | **3.2.0rc1** | Active release-candidate line | Install from a source checkout or a published prerelease tag |
...
After `3.2.0rc1` is published, testers can install the exact release candidate with `pip install "spec-kitty-cli==3.2.0rc1"` or opt into prereleases with `pip install --pre spec-kitty-cli`.
